...
public class TestDeportistas {
	...
	@Test 
	public void  queUnCorredorNoSePuedaInscribirEnUnTriatlon (){		
		// En los triatlones sólo pueden inscribirse los que sean INadador & ICiclista & ICorredor
		Deportista celeste = new Corredor(1000, "Celeste", 10000);
		Club actual = new Club("Sitas");
	...
	@Test
	public void  queUnCorredorPuedaCorrerUnaMaraton() {		
